...
namespace VK.Blocks.Generators.CodeFixes.Observability;

/// <summary>
/// CodeFixProvider that automatically injects Rule 6 compliant observability code.
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            ...
            if (methodDeclaration != null)
            {
                context.RegisterCodeFix(
                    CodeAction.Create(
                        title: "Add VK.Blocks observability pattern (Rule 6)",
