...
namespace VK.Blocks.Core.Utilities.Reflection.Internal;
...
internal sealed class ExpressionEqualityComparer : IEqualityComparer<Expression?>
{
    ...
    private bool CompareLists(ReadOnlyCollection<Expression> left, ReadOnlyCollection<Expression> right)
    {
