...
public interface IVKPropertySetter<TEntity> where TEntity : class
{
    ...
    /// <returns>The current <see cref="IVKPropertySetter{TEntity}"/> instance for chaining.</returns>
    IVKPropertySetter<TEntity> SetProperty<TProperty>(
