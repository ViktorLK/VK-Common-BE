...
using VK.Blocks.AI.Ingest.Common.DependencyInjection.Internal;

namespace VK.Blocks.AI.Ingest;

/// <summary>
/// Service collection extensions for VK.Blocks.AI.Ingest module.
/// Public API Wrapper following BB.03.1.
/// </summary>
[ExcludeFromCodeCoverage]
public static class VKAIIngestBlockExtensions
{
    /// <summary>
    /// Adds the AI Ingest building block to the service collection.
    /// [WRAPPER] pattern for IConfiguration-based registration.
    /// </summary>
    public static IVKAIIngestBuilder AddVKAIIngestBlock(
    ...
    public static IVKAIIngestBuilder AddVKAIIngestBlock(
        this IServiceCollection services,
        IConfiguration configuration,
        Func<VKAIIngestOptions, VKAIIngestOptions> transform)
