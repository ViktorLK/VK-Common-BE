...
/// <summary>
/// AISemanticKernel implementation of <see cref="IVKEmbeddingsEngine"/>.
/// </summary>
internal sealed class AISemanticKernelEmbeddingEngine : AISemanticKernelEngineBase<VKEmbeddingsOptions>, IVKEmbeddingsEngine
{
    private readonly IEmbeddingGenerator<string, Embedding> _defaultEmbeddingService;

    public AISemanticKernelEmbeddingEngine(
        Microsoft.SemanticKernel.Kernel kernel,
        IOptions<VKAIOptions> globalOptions,
        IOptions<VKEmbeddingsOptions> options,
        ILogger<AISemanticKernelEmbeddingEngine> logger,
