...
/// </summary>
internal sealed class AISemanticKernelSpeechEngine(
    Microsoft.SemanticKernel.Kernel kernel,
    IOptions<VKAIOptions> globalOptions,
    IOptions<VKSpeechOptions> options,
    ILogger<AISemanticKernelSpeechEngine> logger,
    TimeProvider? timeProvider = null)
    : AISemanticKernelEngineBase<VKSpeechOptions>(kernel, globalOptions, options, logger, timeProvider), IVKSpeechEngine
{
