...
/// </summary>
internal sealed class AISemanticKernelTranscriptionEngine(
    Microsoft.SemanticKernel.Kernel kernel,
    IOptions<VKAIOptions> globalOptions,
    IOptions<VKTranscriptionOptions> options,
    ILogger<AISemanticKernelTranscriptionEngine> logger,
    TimeProvider? timeProvider = null)
    : AISemanticKernelEngineBase<VKTranscriptionOptions>(kernel, globalOptions, options, logger, timeProvider), IVKTranscriptionEngine
{
