...
/// </summary>
public sealed class VKAISemanticKernelAuditFilter(ILogger<VKAISemanticKernelAuditFilter> logger) : IFunctionInvocationFilter, IPromptRenderFilter
{
    private readonly ILogger<VKAISemanticKernelAuditFilter> _logger = VKGuard.NotNull(logger);
