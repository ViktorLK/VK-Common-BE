...
{
    private readonly ILogger<AISemanticKernelAutoFunctionFilter> _logger = VKGuard.NotNull(logger); // [AP.01]
        ...
        Func<AutoFunctionInvocationContext, Task> next)
    {
        ...
        AISemanticKernelMetrics.RecordAutoToolCall(pluginName, functionName);
