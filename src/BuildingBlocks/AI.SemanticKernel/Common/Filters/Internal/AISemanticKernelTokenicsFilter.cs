...
/// </summary>
internal sealed class AISemanticKernelTokenicsFilter(
    ILogger<AISemanticKernelTokenicsFilter> logger,
...
{
    private readonly ILogger<AISemanticKernelTokenicsFilter> _logger = VKGuard.NotNull(logger);
