...
/// <summary>
/// Diagnostics for the AISemanticKernel building block.
/// </summary>
[VKBlockDiagnostics<VKAISemanticKernelBlock>]
internal static partial class AISemanticKernelLog
{
    [LoggerMessage(
        Level = LogLevel.Information,
        Message = "AISemanticKernel Block initialized for {ModelId}")]
    internal static partial void LogAISemanticKernelBlockInitialized(this ILogger logger, string modelId);

    [LoggerMessage(
        Level = LogLevel.Error,
        Message = "Error occurred during AISemanticKernel execution: {Error}")]
