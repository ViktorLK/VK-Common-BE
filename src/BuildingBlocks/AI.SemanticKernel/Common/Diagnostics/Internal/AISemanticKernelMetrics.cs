...
/// <summary>
/// Metrics for the AISemanticKernel building block.
/// </summary>
[VKBlockDiagnostics<VKAISemanticKernelBlock>]
internal static partial class AISemanticKernelMetrics
{
    ...
    public static void RecordChatDuration(double durationSeconds, string? modelId)
    {
        ...
        {
            { VKAISemanticKernelDiagnosticsConstants.Tags.ModelId, modelId ?? "unknown" }
        });
    }
    ...
    {
        var tags = new TagList { { VKAISemanticKernelDiagnosticsConstants.Tags.ModelId, modelId ?? "unknown" } };

        if (promptTokens > 0)
        {
            var pTags = tags;
            pTags.Add(VKAISemanticKernelDiagnosticsConstants.Tags.TokenType, "prompt");
        ...
        {
            var cTags = tags;
            cTags.Add(VKAISemanticKernelDiagnosticsConstants.Tags.TokenType, "completion");
