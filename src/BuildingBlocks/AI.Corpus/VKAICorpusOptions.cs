...
/// Follows BB.05 / BB.07.
/// </summary>
public sealed record VKAICorpusOptions : IVKToggleableBlockOptions
{
    /// <summary>
    /// The configuration section name for AI.Corpus options.
    /// </summary>
    public static string SectionName => $"{VKBlocksConstants.VKBlocksConfigPrefix}:{VKAICorpusBlock.BlockName}";
