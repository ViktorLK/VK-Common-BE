...
/// </summary>
/// <param name="SessionId">The unique session identifier where the injection occurred.</param>
...
public sealed record VKKnowledgeInjection(VKSessionId SessionId, VKKnowledgeId KnowledgeId, int InjectedTurn, string GroupId);
