...
public sealed class VKDynamicAuthorizeAttribute(string attribute, string @operator, object? value = null) : AuthorizeAttribute, IAuthorizationRequirementData
{
    ...
    public IEnumerable<IAuthorizationRequirement> GetRequirements()
    {
        ...
        {
            Name = $"{DynamicPoliciesConstants.FeatureName}:{Attribute}:{Operator}",
            Attribute = Attribute,
            Operator = Operator,
            Value = Value
        };
