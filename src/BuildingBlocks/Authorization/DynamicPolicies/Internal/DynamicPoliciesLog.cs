...
internal static partial class DynamicPoliciesLog
{
    ...
    internal static partial void LogDynamicAuthorizationSucceeded(
        this ILogger logger,
        string userId,
    ...
    internal static partial void LogDynamicAuthorizationFailed(
        this ILogger logger,
        string userId,
        string requirementName,
        string @operator,
    ...
    [LoggerMessage(
        ...
        EventId = 103,
        Message = "VKError occurred during dynamic authorization check for user {UserId} on requirement {RequirementName}. Code: {ErrorCode}. Message: {ErrorMessage}")]
    internal static partial void LogDynamicAuthorizationError(
        this ILogger logger,
        string userId,
        string requirementName,
        string errorCode,
