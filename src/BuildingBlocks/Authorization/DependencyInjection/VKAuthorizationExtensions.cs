...
/// </summary>
public static class VKAuthorizationExtensions
{
    /// <summary>
    ...
    public static void RecordEvaluation(this Stopwatch sw, string policyName, VKResult<bool> result)
    {
        sw.Stop();
    ...
    /// <summary>
    /// Maps a <see cref="VKResult{T}"/> to the standard ASP.NET Core authorization context.
    /// </summary>
        ...
        IAuthorizationHandler handler)
    {
        ...
        else if (result.IsSuccess)
        {
            ...
            var description = requirement is IVKAuthorizationRequirement vkReq
                ? vkReq.DefaultError.Description
                : "Authorization failed.";
            context.Fail(new AuthorizationFailureReason(handler, description));
        }
        else
        {
