using VK.Blocks.Authorization.WorkingHours;
...
[VKFeature(typeof(VKAuthorizationBlock), OptionsType = typeof(VKWorkingHoursOptions), ArgsGenerationMode = VKArgsGenerationMode.Explicit)]
