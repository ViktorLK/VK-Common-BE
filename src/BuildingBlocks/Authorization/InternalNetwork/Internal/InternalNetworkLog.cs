...
internal static partial class InternalNetworkLog
{
    ...
    internal static partial void LogInternalNetworkGranted(
        this ILogger logger,
        string userId,
        IPAddress? remoteIp,
        string policyName);
    ...
    internal static partial void LogInternalNetworkDenied(
        this ILogger logger,
        string userId,
        IPAddress? remoteIp,
        string policyName);
    ...
    internal static partial void LogRemoteIpCouldNotBeDetermined(
        this ILogger logger,
        string userId,
        string policyName);
}
