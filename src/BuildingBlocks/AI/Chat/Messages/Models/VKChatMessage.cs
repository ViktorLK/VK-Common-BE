...
public sealed record VKChatMessage
{
    ...
    /// <summary>
    /// Gets the tool calls requested by the assistant.
    /// Only applicable when <see cref="Role"/> is <see cref="VKChatRole.Assistant"/>.
    /// </summary>
    public IReadOnlyList<VKToolCall>? ToolCalls { get; init; }

    /// <summary>
    /// Gets the tool result for a specific call.
    /// Only applicable when <see cref="Role"/> is <see cref="VKChatRole.Tool"/>.
    /// </summary>
