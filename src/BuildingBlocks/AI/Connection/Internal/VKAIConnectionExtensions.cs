...
using VK.Blocks.AI.Connection.Internal;
...
public static class VKAIConnectionExtensions
{
        ...
        IVKAIProviderOverrides? overrides = null)
    {
        ...
        // [AP.05] Merge using null-coalescing priority: args?.Property ?? _options.Property
        var provider = overrides?.Provider ?? settings.Provider ?? VKAIProviderType.OpenAI;
