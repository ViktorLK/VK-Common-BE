...
public static class VKAIErrors
{
    ...
    [Obsolete("Use QuotaExceeded instead")]
    public static readonly VKError RateLimitReached = QuotaExceeded;
    [Obsolete("Use AuthenticationFailed instead")]
    public static readonly VKError Unauthorized = AuthenticationFailed;
    [Obsolete("Use Timeout instead")]
    public static readonly VKError RequestTimeout = Timeout;
}
