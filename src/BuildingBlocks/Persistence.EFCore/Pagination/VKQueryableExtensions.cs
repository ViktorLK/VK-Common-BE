...
/// </summary>
public static class VKQueryableExtensions
{
    ...
    public static IQueryable<T> OrderByVKCursorDirection<T, TKey>(
        this IQueryable<T> query,
        ...
        where TKey : IComparable<TKey>
    {
        ...
        var finalAscending = direction == VKCursorDirection.Forward
            ? originalAscending
            : !originalAscending;
