...
/// </summary>
internal sealed class InMemoryApiKeyRevocationProvider(TimeProvider timeProvider) : IVKApiKeyRevocationProvider, IInMemoryCacheCleanup, IAsyncDisposable
{
    private readonly ConcurrentDictionary<string, DateTimeOffset> _revocations = new();
    private readonly object _cleanupLock = new();

    /// <inheritdoc />
    public Type AssociatedServiceType => typeof(IVKApiKeyRevocationProvider);
