...
/// <summary>
/// Validates a refresh token to detect replay attacks and enforce token rotation policies.
/// </summary>
public interface IRefreshTokenValidator
{
    ...
    Task<Result<bool>> ValidateTokenRotationAsync(string tokenJti, string familyId, CancellationToken ct = default);
}
