...
/// </summary>
internal sealed class InMemoryJwtTokenRevocationProvider(TimeProvider timeProvider) : IVKJwtRevocationProvider, IInMemoryCacheCleanup, IAsyncDisposable
{
    ...
    /// <inheritdoc />
    public Type AssociatedServiceType => typeof(IVKJwtRevocationProvider);
