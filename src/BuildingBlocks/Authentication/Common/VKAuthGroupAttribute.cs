...
/// </summary>
/// <remarks>
/// Initializes a new instance of the <see cref="VKAuthGroupAttribute"/> class.
/// </remarks>
/// <param name="groupName">The full policy name of the authentication group (e.g., VKAuthPolicies.GroupUser).</param>
public sealed class VKAuthGroupAttribute(string groupName) : AuthorizeAttribute(groupName);
