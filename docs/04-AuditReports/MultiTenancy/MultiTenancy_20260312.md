...
**該当箇所**: [TenantResolutionResult.cs](/src/BuildingBlocks/MultiTenancy/Abstractions/Contracts/TenantResolutionResult.cs)
...
**該当箇所**: [MultiTenancyServiceCollectionExtensions.cs](/src/BuildingBlocks/MultiTenancy/DependencyInjection/MultiTenancyServiceCollectionExtensions.cs#L31-L41)
...
**該当箇所**: [TenantResolutionMiddleware.cs](/src/BuildingBlocks/MultiTenancy/Resolution/TenantResolutionMiddleware.cs#L52)
...
**該当箇所**: [QueryStringTenantResolver.cs](/src/BuildingBlocks/MultiTenancy/Resolution/Resolvers/QueryStringTenantResolver.cs)
...
**該当箇所**: [TenantResolutionMiddleware.cs](/src/BuildingBlocks/MultiTenancy/Resolution/TenantResolutionMiddleware.cs#L70-L77)
...
**該当箇所**: [TenantContextAccessor.cs](/src/BuildingBlocks/MultiTenancy/Context/TenantContextAccessor.cs#L29-L30)
...
**該当箇所**: [TenantResolutionPipeline.cs](/src/BuildingBlocks/MultiTenancy/Resolution/TenantResolutionPipeline.cs)
...
**該当箇所**: [MultiTenancyServiceCollectionExtensions.cs](/src/BuildingBlocks/MultiTenancy/DependencyInjection/MultiTenancyServiceCollectionExtensions.cs#L45-L46)
...
**該当箇所**: [TenantResolutionMiddleware.cs](/src/BuildingBlocks/MultiTenancy/Resolution/TenantResolutionMiddleware.cs#L68-L76)
...
**該当箇所**: [DomainTenantResolver.cs](/src/BuildingBlocks/MultiTenancy/Resolution/Resolvers/DomainTenantResolver.cs#L76)
