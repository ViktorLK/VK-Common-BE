...
- ❌ **[再帰呼び出し — AspNetCoreExtensions.AddAspNetCoreInstrumentation]**: [AspNetCoreExtensions.cs:8-11](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Extensions/AspNetCoreExtensions.cs#L8-L11)
...
- ❌ **[名前空間の不整合]**: [AspNetCoreExtensions.cs:4](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Extensions/AspNetCoreExtensions.cs#L4)
...
- 🔒 **[PII マスキング — 正規表現ベース] ✅**: [SensitiveDataRedactor.cs:59-77](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Logging/SensitiveDataRedactor.cs#L59-L77)
...
- 🔒 **[ClientIp のログ出力]**: [HttpLogEnricher.cs:45](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Logging/HttpLogEnricher.cs#L45) / [HttpLogEntry.cs:25](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Logging/HttpLogEntry.cs#L25)
  - `ClientIp` (`RemoteIpAddress`) がログに記録されます。GDPR/個人情報保護法の管轄下では IP アドレスは PII に該当する場合があります。IP アドレスのマスキングまたはオプトアウト機能の追加を推奨します。
  - **深刻度**: 🟡 中

- 🔒 **[レスポンスボディキャプチャ — MemoryStream の二重読み取り]**: [RequestLoggingMiddleware.cs:108-113, 141-144](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Middleware/RequestLoggingMiddleware.cs#L108-L113)
...
- 📡 **[構造化ログ — ゼロアロケーション] ✅**: [RequestLoggingMiddleware.cs:29-39](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Middleware/RequestLoggingMiddleware.cs#L29-L39)
  - `LoggerMessage.Define<T1, T2, T3, T4>` によるコンパイル時テンプレートキャッシュ。高スループット環境でのパフォーマンスに配慮された実装です。

- 📡 **[メトリクス — OpenTelemetry Semantic Conventions 準拠] ✅**: [HttpMetricsCollector.cs:37-50](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Metrics/HttpMetricsCollector.cs#L37-L50)
...
- ⚠️ **[Options クラスの型宣言 — class vs sealed record]**: [RequestLoggingOptions.cs:6](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Options/RequestLoggingOptions.cs#L6) / [TraceContextOptions.cs:6](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Options/TraceContextOptions.cs#L6)
...
- ⚠️ **[マジックストリング — HttpLogEnricher スコープキー]**: [HttpLogEnricher.cs:38-45](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Logging/HttpLogEnricher.cs#L38-L45)
...
- ⚠️ **[マジックストリング — HttpMetricsCollector タグキー]**: [HttpMetricsCollector.cs:66-68](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Metrics/HttpMetricsCollector.cs#L66-L68)
...
- ⚠️ **[XML ドキュメント不足 — AspNetCoreExtensions]**: [AspNetCoreExtensions.cs:6-8](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Extensions/AspNetCoreExtensions.cs#L6-L8)
  - クラス・メソッドレベルの XML ドキュメントコメントが一切ありません。公開 API として他の開発者が使用する可能性があるため、`/// <summary>` の追加が必要です。
  - **深刻度**: 🟡 低

- ⚠️ **[LogLevel / ErrorLogLevel の未使用]**: [RequestLoggingOptions.cs:66-73](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.AspNetCore/Options/RequestLoggingOptions.cs#L66-L73)
