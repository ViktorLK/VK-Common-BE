...
- ❌ **[DI アンチパターン — BuildServiceProvider]**: [SerilogObservabilityExtensions.cs:29](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.Serilog/DependencyInjection/SerilogObservabilityExtensions.cs#L29)
...
- 🔒 **[PII マスキングの限界]**: [SensitiveDataEnricher.cs:46-48](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.Serilog/Enrichers/SensitiveDataEnricher.cs#L46-L48)
...
- 🔒 **[中間 ServiceProvider の未破棄]**: [SerilogObservabilityExtensions.cs:29](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.Serilog/DependencyInjection/SerilogObservabilityExtensions.cs#L29)
...
- 📡 **[OTLP エクスポート — 未実装]**: [SerilogOptions.cs:41](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.Serilog/Options/SerilogOptions.cs#L41)
...
- ⚠️ **[マジックストリング — Claim Type]**: [UserContextEnricher.cs:26](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.Serilog/Enrichers/UserContextEnricher.cs#L26)
  - `"tenant_id"` が文字列リテラルとして使用されています。他のモジュール（MultiTenancy 等）で同じ Claim 名が使われる場合、定数の共有が必要です。

- ⚠️ **[Options 内のネスト型]**: [SerilogOptions.cs:64, 73](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.Serilog/Options/SerilogOptions.cs#L64-L73)
...
- ⚠️ **[未使用オプション — MinimumLevel]**: [SerilogOptions.cs:36](file:///e:/code/github/VK-Common-BE/src/BuildingBlocks/Observability.Serilog/Options/SerilogOptions.cs#L36)
...
**Date**: 2026-03-11
**Previous Audit**: [2026-03-06 (98/100)](file:///e:/code/github/VK-Common-BE/docs/04-AuditReports/Observability.Serilog/Observability.Serilog_20260306.md) — 前回は構造的課題の深掘りが不十分であったため、本監査で再評価を実施。
