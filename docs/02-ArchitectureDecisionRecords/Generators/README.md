...
#### [ADR-001: Support Modern C# Features in .NET Standard 2.0 Generators via Polyfills](./adr-001-support-modern-csharp-features-in-netstandard20-generators-via-polyfills.md)
...
#### [ADR-002: Establish Incremental Source Generators Pattern for Infrastructure Boilerplate](./adr-002-establish-incremental-source-generators-pattern-for-infrastructure-boilerplate.md)
...
#### [ADR-003: Automate Observability Infrastructure via Source Generation](./adr-003-automate-observability-infrastructure-via-source-generation.md)
