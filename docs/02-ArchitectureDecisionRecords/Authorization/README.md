...
#### [ADR-001: Centralize Tenant Isolation in Authorization Pipeline](/docs/02-ArchitectureDecisionRecords/Authorization/adr-001-centralize-tenant-isolation-in-authorization-pipeline.md)
...
#### [ADR-002: Establish Dynamic Policy Generation for Permission-Based Authorization](/docs/02-ArchitectureDecisionRecords/Authorization/adr-002-establish-dynamic-policy-generation-for-permission-based-authorization.md)
...
#### [ADR-003: Adopt Attribute Evaluator Pattern for Extensible Custom Requirements](/docs/02-ArchitectureDecisionRecords/Authorization/adr-003-adopt-attribute-evaluator-pattern-for-extensible-custom-requirements.md)
...
#### [ADR-006: Modernize Dynamic Policy Evaluation with IAuthorizationRequirementData](/docs/02-ArchitectureDecisionRecords/Authorization/adr-006-iauthorizationrequirementdata.md)
...
#### [ADR-004: Introduce Source Generators for Authorization Handlers and Permissions Catalog](/docs/02-ArchitectureDecisionRecords/Authorization/adr-004-introduce-source-generators-for-authorization-handlers-and-permissions-catalog.md)
...
#### [ADR-005: Refactor Authorization Evaluation to Specialized Permission Evaluator Pattern and Retain Automation](/docs/02-ArchitectureDecisionRecords/Authorization/adr-005-refactor-authorization-evaluation-to-specialized-permission-evaluator-pattern-and-retain-automation.md)
...
#### [ADR-007: Definition-First Permission Discovery Strategy](/docs/02-ArchitectureDecisionRecords/Authorization/adr-007-definition-first-permission-discovery-strategy.md)

**Status**: ✅ Accepted  
**概要**: 定数クラスからメタデータ（表示名・説明）を抽出し、強タイプ属性を自動生成する「定義優先」のスキャン戦略  
**キーワード**: Source Generators, Metadata-First, Compile-Time Safety

#### [ADR-008: Hash-Based Metadata Synchronization for Startup Performance](/docs/02-ArchitectureDecisionRecords/Authorization/adr-008-hash-based-metadata-synchronization.md)
...
#### [ADR-009: Permission Naming and Isolation Strategy](/docs/02-ArchitectureDecisionRecords/Authorization/adr-009-permission-naming-and-isolation-strategy.md)

**Status**: ✅ Accepted  
**概要**: 属性生成時に Module プレフィックスを強制し、未管理権限に Misc を付与することで、大規模統合時の命名競合を根絶する治理戦略  
**キーワード**: Namespacing, Governance, Conflict Prevention

#### [ADR-010: Standardization of Authorization Vertical Slice Structure and Delegated Registration](/docs/02-ArchitectureDecisionRecords/Authorization/adr-010-standardization-of-authorization-vertical-slice-structure-and-delegated-registration.md)
