...
public sealed class ApiKeyOptionsValidatorTests
{
    ...
    {
        // Arrange
        var options = new VKApiKeyOptions { Enabled = false };
    ...
    {
        // Arrange
        var options = new VKApiKeyOptions
        {
            Enabled = true,
    ...
    {
        // Arrange
        var options = new VKApiKeyOptions { Enabled = true, HeaderName = "" };
    ...
    {
        // Arrange
        var options = new VKApiKeyOptions { Enabled = true, HeaderName = "X-Api-Key", MinLength = -1 };
    ...
    {
        // Arrange
        var options = new VKApiKeyOptions { Enabled = true, SchemeName = "" };
