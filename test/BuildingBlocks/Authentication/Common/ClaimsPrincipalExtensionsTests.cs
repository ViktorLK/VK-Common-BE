...
public sealed class ClaimsPrincipalExtensionsTests
{
    ...
    {
        // Arrange
        var claims = new[] { new Claim(VKClaimTypes.UserId, "vk-user-id") };
        var principal = new ClaimsPrincipal(new ClaimsIdentity(claims));
    ...
    {
        // Arrange
        var claims = new[] { new Claim(VKClaimTypes.Jti, "jti-value") };
        var principal = new ClaimsPrincipal(new ClaimsIdentity(claims));
    ...
    {
        // Arrange
        var claims = new[] { new Claim(VKClaimTypes.PreferredUsername, "vk-user") };
        var principal = new ClaimsPrincipal(new ClaimsIdentity(claims));
    ...
    public void GetRoles_ShouldReturnUniqueRolesFromAllSources()
    {
        ...
        { 
            ...
            new Claim(VKClaimTypes.Role, "User"),
        ...
        // Assert
        roles.Should().HaveCount(2).And.Contain(new[] { "Admin", "User" });
    }
    ...
    public void ToAuthenticatedUser_WithValidPrincipal_ShouldMapCorrectly()
    {
        ...
        { 
            ...
            new Claim(VKClaimTypes.TenantId, "tenant-1"),
            new Claim(ClaimTypes.Role, "Admin"),
    ...
    public void ToAuthenticatedUser_WithMissingMandatoryClaims_ShouldReturnFailure()
    {
        ...
        result.FirstError.Should().Be(AuthenticationErrors.InvalidClaims);
    }
    ...
    {
        // Arrange
        var claims = new[] { new Claim(VKClaimTypes.Name, "display-name") };
        var principal = new ClaimsPrincipal(new ClaimsIdentity(claims));
    ...
    {
        // Arrange
        var claims = new[] { new Claim(VKClaimTypes.AzureTenantId, "azure-tenant") };
        var principal = new ClaimsPrincipal(new ClaimsIdentity(claims));
