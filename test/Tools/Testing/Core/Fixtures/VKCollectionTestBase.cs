...
/// <summary>
/// Base class for tests that belong to a shared xUnit collection (<see cref="ICollectionFixture{TFixture}"/>).
/// Handles automatic per-test database reset, seeding, and ambient context isolation.
/// </summary>
/// <typeparam name="TFixture">The shared collection fixture type.</typeparam>
public abstract class VKCollectionTestBase<TFixture> : IAsyncLifetime
    where TFixture : class, IVKTestFixture
{
    /// <summary>
    /// Gets the shared test fixture instance from the collection.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="VKCollectionTestBase{TFixture}"/> class.
    /// </summary>
    /// <param name="fixture">The collection-level fixture instance injected by xUnit.</param>
    protected VKCollectionTestBase(TFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    /// <summary>
    /// Per-test initialization. Resets DB and executes registered seeders if supported.
    /// </summary>
